...
export type WaterproofAPI = {
    ...
    /**
     * Execute the command or tactic at the state obtained from the current cursor position.
     * @param cmd The command or tactic to execute, this can be multiple steps if they are split using the usual `.`.
     * @returns 
     */
